...
HD_PWD='G:/Agha_VHDL/vorlesung1/vorlesung1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log beispielGate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source beispielGate.tcl
