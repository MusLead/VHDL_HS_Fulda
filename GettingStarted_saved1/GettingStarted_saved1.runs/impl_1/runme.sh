...
HD_PWD='G:/Agha_VHDL/Getting_Started/Getting_Started.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tasterXor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tasterXor.tcl -notrace
