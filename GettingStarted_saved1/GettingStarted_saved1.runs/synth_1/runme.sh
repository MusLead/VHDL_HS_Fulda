...
HD_PWD='G:/Agha_VHDL/Getting_Started/Getting_Started.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tasterXor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tasterXor.tcl
