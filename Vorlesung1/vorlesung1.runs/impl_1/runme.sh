...
HD_PWD='G:/Agha_VHDL/vorlesung1/vorlesung1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log beispielGate.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source beispielGate.tcl -notrace
